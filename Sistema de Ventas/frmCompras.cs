...
namespace Sistema_de_Ventas
{
    public partial class frmCompras : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                IDProducto = cbxID.Text,
                NombreProducto = txtNombre.Text,
                StockProducto = (int)nudCantidad.Value,
                Proveedor = txtProveedor.Text,
                PrecioCompra = (double)nudPrecioCompra.Value,
                PrecioVenta = (double)nudPrecioVenta.Value,
            };

            foreach (Producto miProducto in miProducto.DeserializarLista())
            {
                if (miProducto.IDProducto == cbxID.Text && miProducto.NombreProducto != txtNombre.Text)
                {
        ...
        private void dtgProductosCompra_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                cbxID.Text = miCompra.misProductosCompra[dtgProductosCompra.CurrentCell.RowIndex].IDProducto;
        ...
        {
            foreach (Producto producto in miProducto.DeserializarLista())
            {
        ...
        {
            cbxID.Text = miProducto.misProductos[cbxID.SelectedIndex].IDProducto;
